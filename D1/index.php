...
$language_options = ['english', 'indonesia', 'dutch'];

if(isset($_GET['lang'])){
  if(in_array($_GET['lang'], $language_options)){
    $lang = $_GET['lang'];
    if($lang == 'indonesia'){
      $data = json_decode(file_get_contents('./lang/id.json'), true);
    }else if($lang == 'dutch'){
      $data = json_decode(file_get_contents('./lang/nl.json'), true);
    }
  }
}
?>
  ...
  <body>
        ...
        <ul>
          ...
          <li class="language-form">
            <select name="lang" id="lang">
              ...
              <option value="indonesia" <?= $lang === 'indonesia' ? 'selected' : ''?>>Indonesia</option>
              <option value="dutch" <?= $lang === 'dutch' ? 'selected' : ''?>>Dutch</option>
            </select>
          </li>
        </ul>
      </div>
    ...
    <script>
      ...
      select.addEventListener('input', function(e){
        document.location = `?lang=${e.target.value}`;
      });
